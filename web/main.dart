...
void runFullSlideshow()
{
  ...
  setElementVisibility(eyes, const Duration(seconds:7), const Duration(seconds:9));
  ...
  setElementVisibility(querySelector("#slideshow-text-4"), const Duration(milliseconds:9750), const Duration(seconds:7));
  setElementScale(querySelector("#slideshow-text-4-1"), const Duration(seconds:11), const Duration(seconds:6));
  setElementScale(querySelector("#slideshow-text-4-2"), const Duration(seconds:12), const Duration(seconds:5));
  setElementScale(querySelector("#slideshow-text-4-3"), const Duration(seconds:13), const Duration(seconds:4), onDone: runFullSlideshow);
}
